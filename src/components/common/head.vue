       ...
       <el-col :span="20">
        ...
        <el-col :span="4"> 
          <el-menu :default-active="activeIndex2" class="el-menu-demo" mode="horizontal" 
              ...
              <el-menu-item index="6"><router-link to="/login" style="color:#fff">登陆</router-link></el-menu-item>
              <el-menu-item index="7"><router-link to="/register" style="color:#fff">注册</router-link></el-menu-item>
              </el-submenu>
          </el-menu>
        </el-col>
    </el-row>
